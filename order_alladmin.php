...
$sql_select =" SELECT * from $table $where ORDER BY order_id DESC ";
 ...
 <div class="card text-center">
	 <div class="card-header">
	   <div class="label">รายการคำสั่งซื้อ</div>
	 </div>
		 <!-- Content here -->
		 <br>
	 ...
	 ?>
		 <tbody>      
			 ...
			 <th scope='row'><?= $num ?></th>
			   ...
			   <td><?= $row[8]; ?></td>
			   <td>
				<a href='order_alladmin.php?order_id=<?= $row[0]; ?>'onClick="return confirm('คุณต้องการที่จะลบข้อมูลสินค้านี้หรือไม่ ?')" class='btn btn-danger')'>ลบ</a>
				</td>
			 </tr>
		 </tbody>
		 <?php
