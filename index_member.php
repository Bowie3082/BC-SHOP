          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100" src="picture/slide1.png" alt="devbanban">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="picture/slide2.png" alt="devbanban">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="picture/silde3.png" alt="devbanban">
              </div>
            </div>
